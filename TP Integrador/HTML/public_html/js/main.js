jQuery(document).ready(function($) {
   ...
   jQuery('.tp-banner').show().revolution(
	...
	var latlng = new google.maps.LatLng(-31.436542, -62.098028);
	...
	var marker1 = new google.maps.Marker({
		position: new google.maps.LatLng(-31.436542, -62.098028), 
		map: map,		
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('Carrara', 'Lopez y Planes 2713,<br />San Francisco, CBA, <br />CP.X2400<br />')
	}); 
...
=================================== */
    $("#contact").submit(function (e) {
        ...
        //alert("Disculpe, por el momento no funciona el formulario de contacto. Por favor envíe un email a info@carrarainstalacioneselectromecanicas.com . Gracias");
        ...
        var dataString = 'name=' + name + '&apellido=' + apellido + '&telefono=' + telefono +'&email=' + email + '&message=' + message;
        ...
        if (isValidEmail(email) && (message.length > 1) && (name.length > 1)) {
            $.ajax({
                ...
                data: dataString,
                success: function () {
                    alert("Su mensaje ha sido enviado, gracias por contactarse con nosotros.");
            ...
            alert("Error al enviar el mensaje. Por favor compruebe los datos ingresados.");
        }
        return false;
    });